...
namespace CurrencyConverter
{
    public partial class MainWindow : Window
    {
        ...
        // private is an access modifier. Type or member can be accessed only by code in the same class
        // void = does not return any value
        {
            ...
            //Rows in the Datatble with text and value
            ...
            //Data for from currency Combobox is assigned from datatable
            cmbFromCurrency.ItemsSource = dtCurrency.DefaultView;

            //Displays data in the from currency Combobox
            cmbFromCurrency.DisplayMemberPath = "Text";

            //Sets the value in the from currency Combobox
            cmbFromCurrency.SelectedValuePath = "Value";

            //Makes the default value for from currency Combobox "--SELECT--"
            cmbFromCurrency.SelectedIndex = 0;

            //All properties are set for the to currency Combobox
        ...
        // When you click the convert button it takes you to this method
...
;        }
        ...
        // Clicking the clear button takes you to this method
